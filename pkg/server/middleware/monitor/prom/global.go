/*
	Reference https://github.com/chenjiandongx/ginprom
*/
...
var (
	...
	reqCount = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Namespace: zone.NameSpace,
			Name:      "kex_http_request_count_total",
	...
	reqDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Namespace: zone.NameSpace,
			Name:      "kex_http_request_duration_seconds",
	...
	reqSizeBytes = prometheus.NewSummaryVec(
		prometheus.SummaryOpts{
			Namespace: zone.NameSpace,
			Name:      "kex_http_request_size_bytes",
	...
	respSizeBytes = prometheus.NewSummaryVec(
		prometheus.SummaryOpts{
			Namespace: zone.NameSpace,
			Name:      "kex_http_response_size_bytes",
...
func PromMiddleware(promOpts *PromOpts) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if !(promOpts.checkLabel(status, promOpts.ExcludeRegexStatus) &&
